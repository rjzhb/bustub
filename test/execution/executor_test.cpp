...
TEST_F(ExecutorTest, DISABLE_SimpleRawInsertTest) {
...
TEST_F(ExecutorTest, DISABLE_SimpleSelectInsertTest) {
...
// INSERT INTO empty_table2 VALUES (100, 10), (101, 11), (102, 12)
TEST_F(ExecutorTest, DISABLE_SimpleRawInsertWithIndexTest) {
  // Create Values to insert
  std::vector<Value> val1{ValueFactory::GetIntegerValue(100), ValueFactory::GetIntegerValue(10)};
  std::vector<Value> val2{ValueFactory::GetIntegerValue(101), ValueFactory::GetIntegerValue(11)};
  std::vector<Value> val3{ValueFactory::GetIntegerValue(102), ValueFactory::GetIntegerValue(12)};
...
TEST_F(ExecutorTest, DISABLE_SimpleUpdateTest) {
...
TEST_F(ExecutorTest, DISABLE_SimpleDeleteTest) {
  // Construct query plan
  auto table_info = GetExecutorContext()->GetCatalog()->GetTable("test_1");
  auto &schema = table_info->schema_;
  auto col_a = MakeColumnValueExpression(schema, 0, "colA");
...
TEST_F(ExecutorTest, DISABLE_SimpleNestedLoopJoinTest) {
  const Schema *out_schema1;
  std::unique_ptr<AbstractPlanNode> scan_plan1;
  {
    auto table_info = GetExecutorContext()->GetCatalog()->GetTable("test_1");
...
TEST_F(ExecutorTest, DISABLE_SimpleHashJoinTest) {
...
TEST_F(ExecutorTest, DISABLE_SimpleAggregationTest) {
